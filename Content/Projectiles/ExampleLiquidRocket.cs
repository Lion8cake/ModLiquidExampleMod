...
{
	public class ExampleLiquidRocket : ModProjectile
	{
		...
		{
			ExampleLiquidExplosiveKill(Projectile);
		}

		public static void ExampleLiquidExplosiveKill(Projectile proj, bool isGrenade = false)
		{
			proj.Resize(22, 22);
			if (isGrenade)
			{
			...
			if (Main.netMode != NetmodeID.MultiplayerClient)
			{
				...
				proj.Kill_DirtAndFluidProjectiles_RunDelegateMethodPushUpForHalfBricks(projPos, 3f, SpreadExampleLiquid);
			}
		}

		public static bool SpreadExampleLiquid(int x, int y)
		{
