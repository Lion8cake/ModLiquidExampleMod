...
{
	public class BloodBucket : ModItem
	{
		...
		public override void HoldItem(Player player)
		{
			if (!player.JustDroppedAnItem)
			{
				...
				{
					if (tile.LiquidType != LiquidLoader.LiquidType<ExampleCustomMergeLiquid>())
					{
						return;
					}
				}
				SoundEngine.PlaySound(SoundID.SplashWeak, player.position);
				tile.LiquidType = LiquidLoader.LiquidType<ExampleCustomMergeLiquid>();
